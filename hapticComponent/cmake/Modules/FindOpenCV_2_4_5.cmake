###########################################################
#                  Find OpenCV Library on Windows
...
#
# 2012/02/24 Henry Portilla, support for OpenCV 2.3.1
# 2013/04/08 henry Portilla, support for OpenCv 2.4.5
#
# tested with:
# - OpenCV 2.1:  MinGW, MSVC2008
# - OpenCV 2.0:  MinGW, MSVC2008, GCC4
# - OpenCv 2.4.5: MSVC2008
#
## 4: Licence:
#
...
if(EXISTS "${OpenCV_DIR}")
        ...
        #Otherwise it try to guess it.
				...
				set(OPENCV_LIB_COMPONENTS core highgui imgproc features2d flann ml gpu 
					haartraining_engine legacy objdetect ts video calib3d contrib photo stitching superres videostab nonfree)
				...
				# message("OpenCV version:" OpenCV_VERSION_MAJOR)
        ...
        foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
				...
				if(MSVC90)
					find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "opencv_${__CVLIB}${CVLIB_SUFFIX}d" "lib${__CVLIB}${CVLIB_SUFFIX}d" PATHS "${OpenCV_DIR}/opencv/build/${CMAKE_HOST_SYSTEM_PROCESSOR}/vc9/lib" NO_DEFAULT_PATH)
					find_library(OpenCV_${__CVLIB}_LIBRARY_RELEASE NAMES "opencv_${__CVLIB}${CVLIB_SUFFIX}" "lib${__CVLIB}${CVLIB_SUFFIX}" PATHS "${OpenCV_DIR}/opencv/build/${CMAKE_HOST_SYSTEM_PROCESSOR}/vc9/lib" NO_DEFAULT_PATH)
				endif()
