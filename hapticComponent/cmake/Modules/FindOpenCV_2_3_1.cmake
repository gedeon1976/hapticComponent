...
if(EXISTS "${OpenCV_DIR}")
        ...
        #Otherwise it try to guess it.
                ...
                set(OPENCV_LIB_COMPONENTS core highgui imgproc features2d flann ml gpu 
					haartraining_engine legacy objdetect ts video calib3d contrib)
        ...
        foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
                ...
                find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "opencv_${__CVLIB}${CVLIB_SUFFIX}d" "lib${__CVLIB}${CVLIB_SUFFIX}d" PATHS "${OpenCV_DIR}/build/x64/vc9/lib" NO_DEFAULT_PATH)
                find_library(OpenCV_${__CVLIB}_LIBRARY_RELEASE NAMES "opencv_${__CVLIB}${CVLIB_SUFFIX}" "lib${__CVLIB}${CVLIB_SUFFIX}" PATHS "${OpenCV_DIR}/build/x64/vc9/lib" NO_DEFAULT_PATH)
